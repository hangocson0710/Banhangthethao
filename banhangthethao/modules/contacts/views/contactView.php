        ...
        <div class="section" id="order-review-wp">
            ...
            <div class="section-detail">
                <table class="shop-table">
                    <thead>
                        <tr>
                            <td>LOCALSTORE INC.</td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="cart-item">
                            <td class="product-name">Cao Lỗ, Quận 8, Thành Phố Hồ Chí Minh, Việt Nam<strong class="product-quantity">x 1</strong></td>
                        </tr>
                        <tr class="cart-item">
                            <td class="product-name">Điện thoại: 038 746 78 13</td>
                        </tr>
                        <tr class="cart-item">
                            <td class="product-name">Fax: 1-714-252-0026<strong class="product-quantity">x 2</strong></td>
                        </tr>
                        <tr class="order-total">
                            <td><strong class="total-price">Email: dh51901152@student.stu.edu.vn</strong></td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr class="order-total">
                        		...
                        		<strong class="total-price">
                        			<ul>
										<li style="display: inline-block; padding: 0px 20px; font-size: 50px;">
											<a style="color:gray;" href="https://www.facebook.com/profile.php?id=100009348832679"><i class="fa fa-facebook"></i></a>
										</li >
										<li style="display: inline-block;padding: 0px 20px;font-size: 50px;">
